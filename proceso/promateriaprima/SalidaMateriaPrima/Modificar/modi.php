...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE TRNSALIDA_MAT_PRIM SET CANTMAT_PRIMA=%s, ID_MATPRIMA=%s, IDUNIDAD=%s WHERE ID_SALIDA=%s",
...
<table width="820" border="0">
  <tr>
    <td bgcolor="#999999" class="encaforms">Modificar Salida de Materia Prima</td>
  </tr>
  <tr>
          ...
          <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
            <table align="center">
              <tr valign="baseline">
                ...
                <td nowrap="nowrap" align="right"><?php echo $row_conmodi['ID_SALIDA']; ?></td>
              ...
              <tr valign="baseline">
                ...
                <td nowrap="nowrap" align="left"><input type="text" name="CANTMAT_PRIMA" value="<?php echo htmlentities($row_conmodi['CANTMAT_PRIMA'], ENT_COMPAT, 'utf-8'); ?>" size="9" /></td>
                <td nowrap="nowrap" align="right">Unidad de Medida:</td>
                <td><select name="IDUNIDAD">
                  <?php 
do {  
?>
                  <option value="<?php echo $row_comboMedida['IDUNIDAD']?>" <?php if (!(strcmp($row_comboMedida['IDUNIDAD'], htmlentities($row_conmodi['IDUNIDAD'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_comboMedida['TIPOUNIDAD']?></option>
                  <?php
...
do {  
?>
                  <option value="<?php echo $row_comboProducto['IDMATPRIMA']?>" <?php if (!(strcmp($row_comboProducto['IDMATPRIMA'], htmlentities($row_conmodi['ID_MATPRIMA'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_comboProducto['DESCRIPCION']?></option>
                  <?php
...
?>
            ...
            <input type="hidden" name="ID_SALIDA" value="<?php echo $row_conmodi['ID_SALIDA']; ?>" />
          </form>
          <p>&nbsp;</p></td>
      </tr>
    </table></td>
...
$totalRows_Producto = mysql_num_rows($Producto);
			...
			?>
              <tr>
                ...
                <td align="center" bgcolor="#666666"><a href="modi.php?enca=<?php echo $row_ultregis['IDENCABEZADOSALMATPRI']; ?>&IDOR=<?php echo $row_ultdetad['ID_SALIDA']; ?>" target="_self"><img src="../../../../imagenes/icono/modi.png" width="32" height="32" /></a></td>
                <td align="center" bgcolor="#666666"><a href="javascript:;" onclick="aviso('eliminar.php?id=<?php echo $row_ultdetad['ID_SALIDA']; ?>'); return false;"><img src="../../../../imagenes/icono/delete-32.png" width="32" height="32"/></a></td>
              </tr>
