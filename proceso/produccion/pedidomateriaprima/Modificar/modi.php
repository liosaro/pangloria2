...
<table width="820" border="0">
  <tr>
    <td bgcolor="#999999" class="encaforms">Modificar Pedido de Materia Prima</td>
  </tr>
  <tr>
    ...
    <td><table width="100%" border="1">
      <tr>
        <td>
          ...
          <table align="center">
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">ID_PED_MAT_PRIMA:</td>
                <td nowrap="nowrap" align="left"><?php echo $row_conmodi['ID_PED_MAT_PRIMA']; ?></td>
              ...
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Cantidad:</td>
                <td nowrap="nowrap" align="left"><input type="text" name="CANTIDADPEDMATPRI" value="<?php echo htmlentities($row_conmodi['CANTIDADPEDMATPRI'], ENT_COMPAT, 'utf-8'); ?>" size="9" /></td>
                <td nowrap="nowrap" align="left">Unidad de Medida:</td>
                <td align="left"><select name="IDUNIDAD">
                  <?php 
do {  
?>
...
?>
                ...
                <td align="left">Materia Prima:</td>
                <td align="left"><select name="IDMATPRIMA">
                  <?php 
do {  
?>
                  <option value="<?php echo $row_comboProducto['IDMATPRIMA']?>" <?php if (!(strcmp($row_comboProducto['IDMATPRIMA'], htmlentities($row_conmodi['IDMATPRIMA'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_comboProducto['DESCRIPCION']?></option>
                  <?php
} while ($row_comboProducto = mysql_fetch_assoc($comboProducto));
?>
                </select></td>
                <td align="left"><input type="submit" value="Actualizar registro" /></td>
              </tr>
              <tr> </tr>
              <tr> </tr>
              </table>
            <input type="hidden" name="MM_update" value="form1" />
            <input type="hidden" name="ID_PED_MAT_PRIMA" value="<?php echo $row_conmodi['ID_PED_MAT_PRIMA']; ?>" />
          </form></td>
      </tr>
    </table></td>
  </tr>
