...
$query_filtradoproducto = sprintf("SELECT * FROM CATUNIDADES WHERE TIPOUNIDADDESCRIPCION LIKE %s AND ELIMIN = 0", GetSQLValueString("%" . $colname_filtradoproducto . "%", "text"));
...
<table border="1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" bgcolor="#999999"><strong>Codigo de Unidad de Peso</strong></td>
    <td align="center" bgcolor="#999999"><strong>Unidad de Peso</strong></td>
  </tr>
  <?php do { ?>
    <tr>
      <td><a href="modificadorPermiso.php?root=<?php echo $row_filtradoproducto['IDUNIDAD']; ?>" target="modiprodu">Modificar</a></td>
      <td><?php echo $row_filtradoproducto['IDUNIDADIDPERMISO']; ?></td>
      <td><?php echo $row_filtradoproducto['TIPOUNIDADDESCRIPCION']; ?></td>
    </tr>
