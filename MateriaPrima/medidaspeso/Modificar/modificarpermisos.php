...
$query_consultapermi = "SELECT * FROM CATUNIDADES WHERE ELIMIN=0";
            ...
            <tr>
              <td width="800" colspan="6" align="left">&nbsp;
                ...
                <table border="1" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center">&nbsp;</td>
                    <td align="center">Codigo de Unidad de Peso</td>
                    <td align="center">Unidad de Peso</td>
                    <td align="center">Modificar</td>
                    </tr>
                  <?php do { ?>
                    <tr>
                      <td>&nbsp;</td>
                      <td><?php echo $row_consultapermi['IDUNIDADID']; ?></td>
                      <td><?php echo $row_consultapermi['TIPOUNIDAD']; ?></td>
                      <td><a href="modificadorPermiso.php?root=<?php echo $row_consultapermi['IDUNIDADIDPERMISO']; ?>" target="modiprodu"><img src="../../../imagenes/icono/modi.png" width="32" height="32" /></a></td>
                      </tr>
