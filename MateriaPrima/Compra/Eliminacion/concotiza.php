...
<table width="820" border="0">
  <tr>
    <td align="center" class="encaforms">Eliminación de  Compra</td>
  </tr>
  <tr>
    <td><table width="820" border="0">
      <tr>
        ...
        <td class="retorno">&nbsp;</td>
        <td class="etifactu">&nbsp;</td>
        <td align="right" class="retorno"><a href="javascript:;" onclick="aviso('eliminar.php?root=<?php echo $row_ultimaorden['ID_DETENCCOM']; ?>'); return false;"><img src="../../../imagenes/icono/delete-32.png" alt="" width="32" height="32" /></a></td>
      </tr>
      <tr>
