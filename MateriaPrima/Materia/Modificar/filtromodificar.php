...
if (isset($_POST['filtromateria'])) {
  $colname_filtromate = $_POST['filtromateria'];
}
mysql_select_db($database_basepangloria, $basepangloria);
$query_filtromate = sprintf("SELECT * FROM CATMATERIAPRIMA WHERE DESCRIPCION LIKE %s ORDER BY DESCRIPCION ASC", GetSQLValueString("%" . $colname_filtromate . "%", "text"));
...
<body><iframe src="cmdo.php" name="modificar2" width="820" height="250" scrolling="NO" id="modificar"></iframe>
<p>&nbsp;</p>
<table border="1">
  <tr>
    <td>Modificar</td>
  ...
  <?php do { ?>
    <tr>
      <td><a href="cmdo.php?root=<?php echo $row_filtromate['IDMATPRIMA']; ?>" target="modificar2">Modificar</a></td>
