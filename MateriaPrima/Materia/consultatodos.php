...
$query_todos = "SELECT * FROM CATMATERIAPRIMA ORDER BY IDMATPRIMA ASC";
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_todos['IDMATPRIMA']; ?></td>
      <td><?php echo $row_todos['IDTIPO']; ?></td>
      <td><?php echo $row_todos['DESCRIPCION']; ?></td>
      <td><?php echo $row_todos['UBICACIONBODEGA']; ?></td>
    </tr>
