...
mysql_select_db($database_basepangloria, $basepangloria);
$query_ubicacion = "SELECT IDUBICACION, LUGAR FROM CATUBICACION";
    ...
    <td><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="820" border="0">
          ...
          <tr>
            ...
            <td><input name="IDMATPRIMA" type="text" disabled="disabled" value="<?php echo $row_materia['IDMATPRIMA']+1; ?>" size="32" readonly="readonly" /></td>
...
?>
          ...
          <tr>
            ...
            <td>Ubicacion de Materia Prima</td>
            <td><select name="UBICACIONBODEGA">
              <?php
do {  
?>
