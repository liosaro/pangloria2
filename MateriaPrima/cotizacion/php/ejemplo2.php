...
<html>
    ...
    <body>
        ...
        <h1 style="font-family: verdana; font-size: 10 em; font-weight: bold; text-align: center;">Ingreso de Cotizaci&oacute;n</h1>
        ...
        <p style="font-family: verdana; font-size: 5 em; font-weight: bold;"><u> DETALLE DE ITEMS</p></u>
       <br />
        ...
        <table  id="detalle"  name="detalle"  style="font-family: verdana; font-size: 0.9em;">
         ...
         <input type="image" src="../cotizacion/floppy-disk-icon2.png" width="70" value="GUARDAR COTIZACION">
