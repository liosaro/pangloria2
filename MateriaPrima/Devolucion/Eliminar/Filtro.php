...
mysql_select_db($database_basepangloria, $basepangloria);
 ...
 if (isset($_GET['fechai']) && isset($_GET['fechaf'])) {
        ...
        $row_consulta = "SELECT * FROM TRNDEVOLUCIONCOMPRA WHERE FECHADEVOLUCION BETWEEN $fechainicio AND $fechafin And ELIMIN=0  ORDER BY FECHADEVOLUCION DESC";
...
<table width="820" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td>Codigo de Devolucion de Compra</td>
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $result['IDDEVOLUCION']; ?></td>
      <td><?php echo $result['FECHADEVOLUCION']; ?></td>
      <td><?php echo $result['ID_DETENCCOM']; ?></td>
      <td><a href="modificar.php?dev=<?php echo $result['IDDEVOLUCION']; ?>"><img src="../../../imagenes/icono/3D-Search-32.png" width="32" height="32" /></a></td>
    </tr>
