...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" class="encaforms">Eliminar Devolución de Compra</td>
    </tr>
    <tr valign="baseline">
...
<span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
    ...
    <tr valign="baseline">
      ...
      <td><a href="javascript:;" onclick="aviso('eliminar.php?root=<?php echo $row_consultaDevolucion['IDDEVOLUCION']; ?>'); return false;"><img src="../../../imagenes/icono/delete-32.png" width="32" height="32" /></a></td>
    </tr>
  </table>
