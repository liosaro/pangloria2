...
$query_consultapermi = "SELECT * FROM CATUBICACION WHERE ELIMIN=0";
            ...
            <tr>
              <td width="800" colspan="6" align="left">&nbsp;
                ...
                <table border="1" cellpadding="0" cellspacing="0">
                  ...
                  <?php do { ?>
                    <tr>
                      <td><a href="javascript:;" onclick="aviso('eliminaPermiso.php?id=<?php echo $row_consultapermi['IDUBICACION']; ?>'); return false;"><img src="../../../imagenes/icono/delete-32.png" alt="" width="32" height="32" /></a></td>
