...
$query_consultapermi = "SELECT IDUBICACION, LUGAR FROM CATUBICACION WHERE ELIMIN = 0";
  ...
  <table width="844" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="844" align="center"><div class="cont">
        <form action="filtromodificapermiso.php" method="post" name="envioproductomodifica" target="modiprodu" id="envioproductomodifica">
            ...
            <tr>
              <td width="800" colspan="6" align="left">&nbsp;
                ...
                <p>
                  ...
                  <input type="submit" name="filtrar" id="filtrar" value="Nombre de Ubicacion" />
                </p>
                <table border="1" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center">&nbsp;</td>
                    <td align="center">Código Ubicación</td>
                  ...
                  <?php do { ?>
                    <tr>
                      <td>&nbsp;</td>
                      <td><?php echo $row_consultapermi['IDUBICACION']; ?></td>
                      <td><?php echo $row_consultapermi['LUGAR']; ?></td>
                      <td><a href="modificadorPermiso.php?root=<?php echo $row_consultapermi['IDUBICACION']; ?>" target="modiprodu"><img src="../../../imagenes/icono/modi.png" width="32" height="32" /></a></td>
                      </tr>
